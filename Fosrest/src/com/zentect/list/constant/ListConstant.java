...
public class ListConstant {
    ...
    static {
        ...
        atrainingTypeMap.put("Training of Trainers", "Training of Trainers");
        atrainingTypeMap.put("Specific Training", "Specific Training");
  ...
  //User Type
    ...
    static {
        ...
        atrainingPhaseMap.put("Foundation", "Foundation");
        atrainingPhaseMap.put("Refresher", "Refresher");
        atrainingPhaseMap.put("Onjob", "Onjob");
  ...
  //Trainer 
    ...
    public static final Map<String, String> Result;
    static {
        Map<String, String> auserTypeMap = new HashMap<String, String>();
        auserTypeMap.put("P", "Pass");
        auserTypeMap.put("F", "Fail");
        Result = Collections.unmodifiableMap(auserTypeMap);
    }
}
