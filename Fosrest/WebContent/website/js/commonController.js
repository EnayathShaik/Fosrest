...
function endTimeValidation(startTime , endTime){

    console.log("startTime "+startTime + " endTime "+endTime);
    var stt = new Date("October 03, 1991 " + startTime);
    stt = stt.getTime();

    var endt = new Date("October 03, 1991 " + endTime );
    endt = endt.getTime();
