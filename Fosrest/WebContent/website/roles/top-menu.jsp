...
<body>
				...
				<div class="col-xs-12">
					<div class="navbar-header">
						<button type="button" class="navbar-toggle collapsed"
							...
							aria-expanded="false" aria-controls="navbar" style="margin-right:95px !importnt;">
	...
	<div class="container">
	 <nav class="navbar navbar-default navbar-fixed-top horizontal-nav-top horizontal-top-nav-border">
	<div class="row">
	<div class="col-sm-10 col-xs-10 col-md-10 col-lg-10" style="width:90%;">
	<div class="navbar-header">
                                <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar"> <span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button>
                            </div>
                            ...
                            <div id="navbar" class="navbar-collapse collapse">
                                <ul class="nav navbar-nav">
                                   ...
                                   <!--  <li> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">User Management<span class="caret"></span></a>
                                    ...
                                    <li><a href="traineeUserManagementForm.fssai" class="clr">Trainee Management</a></li>
                                    <li><a href="trainerUserManagementForm.fssai" class="clr">Trainer Management</a></li>
                                     <li><a href="trainingCenterUserManagementForm.fssai" class="clr">Training Institute Management</a></li>
                                </ul>
                                <ul class="nav navbar-nav navbar-right">
							<li class="dropdown active"><a href="#"
								class="dropdown-toggle" data-toggle="dropdown" role="button"
