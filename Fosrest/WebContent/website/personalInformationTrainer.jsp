...
<!-- <head> -->
 ...
 function OnStart(){
	...
	<cf:form action="PersonalInformationTrainerAdd.fssai" name="myForm" method="POST"
		commandName="PersonalInformationTrainer">
  ...
  <fieldset>
                            ...
                            <div class="col-md-6 col-xs-12">
                                <div class="form-group">
                                    <div>
                                        <ul class="lab-no">
                                            <li class="style-li"><strong>Experience Background:</strong></li>
                                            <li class="style-li error-red"> </li>
                                        </ul>
                                    </div>
                                      	<cf:select path="ExpBackground" class="form-control">
                                        	<cf:option value="0" label="Select Expe Background" />
                                ...
                                <div class="form-group">
                                    <div>
                                        <ul class="lab-no">
                                            <li class="style-li"><strong>Food Safety Experience:</strong></li>
                                            <li class="style-li error-red"> </li>
                                        </ul>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <cf:input type="text" path="sessWishToConduct" class="form-control" placeholder="Session Number" required=""/> </div>
                            </div>
                            <!-- left side ends -->
                            <!-- right side -->
                            <div class="col-md-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Session Number" required=""> </div>
                                <div class="form-group">
                                    <label>Associated with any Training Institute ?</label>
                                    <br>
                                ...
                                <div class="form-group">
                                    <div>
                                        <ul class="lab-no">
                                            <li class="style-li"><strong>If Yes Training Institute Name:</strong></li>
                                            <li class="style-li error-red"> </li>
                                        </ul>
                                    </div>
