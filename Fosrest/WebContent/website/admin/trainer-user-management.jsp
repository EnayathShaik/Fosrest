<%@ taglib prefix="cf" uri="http://www.springframework.org/tags/form"%>
 ...
 <style>
   ...
   cursor: default;
            ...
            <cf:form action="trainerUserManagementSearch.fssai" name="myForm" method="POST" commandName="trainerUserManagementForm">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 table-overflow-responsive">
                                                     <table id="datatablesfosrest" class="table table-bordered table-responsive">
                                                        ...
                                                        <tbody>
                                                            <ct:choose>
                                                                <ct:when test="${not empty searchTrainerUsermanagement }">
                                                                    <ct:forEach var="listValue" items="${searchTrainerUsermanagement}" varStatus="loop">
                                                                        <tr>
                                                                            <td>
                                                                            <% if(session.getAttribute("profileId").equals(1)){%>
                                                                            	   <label><a  class="disabled" href="PersonalInformationTrainer.fssai?userId=${listValue[6]}" value="${listValue[0]}">${listValue[1]}</a></label>
                                                                              <%  }else{%>
                                                                                   <label><a href="PersonalInformationTrainer.fssai?userId=${listValue[6]}" value="${listValue[0]}">${listValue[1]}</a></label>
                                                                                   <%    }%> 
                                                                                <%-- <label><a  class="disabled" href="PersonalInformationTrainer.fssai?userId=${listValue[6]}" value="${listValue[0]}">${listValue[1]}</a></label> --%>
                                                                            </td>
                                                                            <td>
                ...
                function activateDeActivateUser(loginDetails,status,profileID){
                	if(confirm("Are you Sure ? You want to "+status )){
                		...
                		$("#trainerUserManagementForm").attr("action" , "activateDeActivateTrainer.fssai");
                    } else{
                        return false;
                    }
                }
