							...
							<div class="row">
								...
								<div class="col-xs-12">
									...
									<div class="row">
										<div class="col-xs-12">
											<fieldset>
												<legend>Create Schedule <label id="result" class=" error-red">${result }</label>&nbsp </legend>
												<!-- left side -->
												<div class="col-xs-6">
