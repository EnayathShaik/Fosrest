...
<cf:form action="${addAction}" name="myForm" method="POST"
	commandName="HolidayMaster" onsubmit="return validateFields();">
	<section>
				...
				<div id="page-content-wrapper">
					<div class="container-fluid">
						...
						<div class="row">
							...
							<div class="col-xs-12">
								<h1>
									Holiday Master <label id="created">${created }</label>
								</h1>
								<div class="row">
									<div class="col-xs-12">
										<fieldset>
											...
											<div class="col-md-6 col-xs-12">
												<div class="form-group">
													...
													<cf:input class="form-control" path="holidayDate"
														id="holidayDate" name="holidayDate" type="text"
														placeholder="Date" />
												</div>
												<div class="form-group">
													<div>
														<ul class="lab-no">
															<li class="style-li"><strong>Holiday
																	Reason:</strong></li>
															<li class="style-li error-red"></li>
														</ul>
													</div>
													<cf:input class="form-control" type="text"
														path="holidayReason" id="holidayReason"
														name="holidayReason"
														placeholder="Training Partner Website Link" />
												</div>
												<div class="row">
										...
										<fieldset>
											...
											<ct:if test="${!empty listHolidayMaster}">
												<table class="table table-bordered table-responsive">
													...
													<ct:forEach items="${listHolidayMaster}"
														var="HolidayMaster">
														<tr>
															...
															<td><button
																	onclick='editHoliday(${HolidayMaster.holidayId});return false;'>Edit</button></td>
															<td><a
																href="<ct:url value='/HolidayMaster/remove/${HolidayMaster.holidayId}.fssai' />">Delete</a></td>
														</tr>
													</ct:forEach>
												</table>
											</ct:if>
